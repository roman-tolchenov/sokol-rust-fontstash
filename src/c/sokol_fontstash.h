...
SOKOL_FONTSTASH_API_DECL FONScontext* sfons_create_context(int width, int height);
...
FONScontext* sfons_create_context(int width, int height) {
    sfons_desc_t desc;
    _sfons_clear(&desc, sizeof(desc));
    desc.width = width;
    desc.height = height;
